...
public class DirectorsParser extends Parser {
	...
	public static final int
		...
		RULE_directorList = 4, RULE_directorAndWork = 5, RULE_directorName = 6, 
		RULE_workList = 7, RULE_workElement = 8;
	public static final String[] ruleNames = {
		"r", "anythingButStart", "anyline", "anyLineOrEOF", "directorList", "directorAndWork", 
		"directorName", "workList", "workElement"
	};
	...
	public static class DirectorListContext extends ParserRuleContext {
		public List<DirectorAndWorkContext> directorAndWork() {
			return getRuleContexts(DirectorAndWorkContext.class);
		}
		public DirectorAndWorkContext directorAndWork(int i) {
			return getRuleContext(DirectorAndWorkContext.class,i);
		}
	...
	public static class DirectorAndWorkContext extends ParserRuleContext {
		public DirectorNameContext directorName() {
			return getRuleContext(DirectorNameContext.class,0);
		}
		...
		public TerminalNode NEWLINE() { return getToken(DirectorsParser.NEWLINE, 0); }
		public DirectorAndWorkContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_directorAndWork; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DirectorsListener ) ((DirectorsListener)listener).enterDirectorAndWork(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DirectorsListener ) ((DirectorsListener)listener).exitDirectorAndWork(this);
		}
	}

	public final DirectorAndWorkContext directorAndWork() throws RecognitionException {
		DirectorAndWorkContext _localctx = new DirectorAndWorkContext(_ctx, getState());
		enterRule(_localctx, 10, RULE_directorAndWork);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(57);
	...
	public final DirectorNameContext directorName() throws RecognitionException {
		...
		enterRule(_localctx, 12, RULE_directorName);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(62);
